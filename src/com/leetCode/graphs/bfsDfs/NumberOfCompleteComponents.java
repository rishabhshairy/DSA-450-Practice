package com.leetCode.graphs.bfsDfs;

import java.util.*;

public class NumberOfCompleteComponents {
    public static void main(String[] args) {
        NumberOfCompleteComponents obj = new NumberOfCompleteComponents();
        obj.countCompleteComponents(5, new int[][]{{1, 2}, {3, 4}, {1, 4}, {2, 3}, {1, 3}, {2, 4}});
    }
